...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			...
			function fn1(pid) {
				//弹出一个确认框
				var flag = confirm("您确定要删除这个商品吗?")
				if(flag){
					//要删除
					//向服务器发送请求，从购物车中移除购物项
					location.href = "${pageContext.request.contextPath}/car?methodStr=delete&pid="+pid
				}
			}
			...
			function fn2() {
				...
				if(flag){
					//要清空
					location.href = "${pageContext.request.contextPath}/car?methodStr=clear"
				}
			}
		</script>
		<style>
		...
		<div class="container">
			<div class="row">
				<div style="margin:0 auto; margin-top:10px;width:950px;">
					<c:if test="${car.totalPrice == 0 || car == null}">
						<h1>购物车空空如也，请抓紧选购自己喜欢和不喜欢的商品吧~~~</h1>
					</c:if>
					<c:if test="${car.totalPrice != 0 && car!=null}">
			...
			<div style="margin-right:130px;">
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="#" id="clear" class="clear" onclick="fn2()">清空购物车</a>
