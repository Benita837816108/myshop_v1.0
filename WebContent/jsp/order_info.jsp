...
<html>
	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							<tr class="warning">
								...
								<th colspan="3">订单时间:${order.ordertime } </th>
							</tr>
							<tr class="warning">
								<th>图片</th>
								<th>商品</th>
			...
			<div>
				<hr/>
				<form class="form-horizontal" style="margin-top:5px;margin-left:150px;" action="${pageContext.request.contextPath }/order" method="get" id="orderForm">
