...
<HTML>
	...
	$(function(){
		$.post(
				"${pageContext.request.contextPath}/adminCategory?methodStr=findAll1",
			function(data) {
				var content = "";
	...
	function fn1(pid) {
		location.href = "${ pageContext.request.contextPath }/adminProduct?methodStr=findProductByPid&pid="+pid
	}
		
	</script>
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct?methodStr=edit" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						...
						<select name="is_hot" value="${product.is_hot }">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="categorySecond.csid" id="cid">
								...
								<option value="${product.category.cname }"></option>
				...
				<tr>
					<td class="ta_01" style="WIDTH: 100%" align="center"
						...
						<FONT face="宋体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</FONT>
						<button type="reset" value="重置" class="button_cancel" onclick="fn1(${product.pid })">&#37325;&#32622;</button>
